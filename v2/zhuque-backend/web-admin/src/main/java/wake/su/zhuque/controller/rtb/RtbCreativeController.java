...
public class RtbCreativeController {
  ...
  public Result<Void> update(@PathVariable Long id, @RequestBody CreativeUpdateRequest request) {
    request.setId(id);
  ...
  public Result<java.util.List<CreativeListVO>> list(@RequestBody CreativeQueryRequest request) {
