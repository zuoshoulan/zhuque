...
public class Imp {
  ...
  @Schema(description = "展示机会的唯一标识符", example = "imp-001", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  private String id;
  ...
  public static class NativeX {
    @Schema(description = """
        ...
        """, requiredMode = Schema.RequiredMode.REQUIRED, example = "{\"assets\":[{\"id\":1,\"required\":1,\"title\":{\"text\":25}}]}")
  ...
  public static class Deal {
    @Schema(description = "交易唯一标识符", example = "deal-123", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("id")
    private String id;
