 ...
 * 超级管理员配置
 *
 * <p>通过配置文件指定超级管理员的用户ID列表，提供以下保护：</p>
 * <ul>
 *   <li>禁止删除超级管理员对应的用户数据</li>
 *   <li>禁止删除超级管理员拥有的角色和权限</li>
 *   <li>超级管理员自动拥有所有权限（绕过权限校验）</li>
 * </ul>
 *
 * <p><strong>重要提示：</strong></p>
 * <ul>
 *   <li>超级管理员仍然是数据库中的普通用户，正常登录即可</li>
 *   <li>配置文件只是指定哪些用户ID需要特殊保护</li>
 *   <li>即使数据库权限数据被误删，超级管理员仍然可以访问所有功能</li>
 * </ul>
 *
 * @author 朱雀项目
 * @since 2.0.0
