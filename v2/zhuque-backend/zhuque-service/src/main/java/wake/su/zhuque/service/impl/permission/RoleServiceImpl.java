...
public class RoleServiceImpl implements RoleService {
  ...
  public void deleteRole(Long id) {
    ...
    // 删除角色的权限关联
    rolePermissionMapper.delete(new LambdaQueryWrapper<SysRolePermissionDO>().eq(SysRolePermissionDO::getRoleId, id));
  ...
  public List<RoleVO> getRoleList() {
    List<SysRoleDO> roles = roleMapper.selectList(new LambdaQueryWrapper<SysRoleDO>().eq(SysRoleDO::getStatus, 1));
  ...
  public List<Long> getRolePermissionIds(Long roleId) {
    List<SysRolePermissionDO> list = rolePermissionMapper
        .selectList(new LambdaQueryWrapper<SysRolePermissionDO>().eq(SysRolePermissionDO::getRoleId, roleId));
  ...
  public Result<List<RoleVO>> getRolePage(RolePageQuery query) {
    ...
    // 分页查询
    Page<SysRoleDO> page = new Page<>(query.getCurrent() != null ? query.getCurrent() : 1,
