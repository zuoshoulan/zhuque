...
-- ----------------------------
-- 3. Banner素材扩展表 (rtb_material_banner)
...
-- ----------------------------
-- 4. Video素材扩展表 (rtb_material_video)
...
-- ----------------------------
-- 5. Audio素材扩展表 (rtb_material_audio)
...
-- ----------------------------
-- 6. Native素材扩展表 (rtb_material_native)
...
INSERT INTO `rtb_creative` (
    `creative_id`, `advertiser_id`, `name`, `description`, `format`,
    `landing_page_url`, `display_url`, `advertiser_domain`,
    `cat`, `language`, `status`, `create_by`
) VALUES (
    'C001', 1, '双11促销Banner活动', '双11电商促销活动Banner', 1,
